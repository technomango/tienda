		...
		<div class="col-md-6">
			 <div class="titulo-header-text">
        		<div class="add-item d-flex">
					<div class="page-title">
						...
						<h6>Crear un nuevo producto para la tienda</h6>
					</div>
				</div>
    		</div>
		</div>
			<div class="col-md-6">
			 <div class="titulo-header-text-right">
        		<div class="add-item d-flex">
					<div class="page-title">
						<a href="../products" class="btn btn-primary"><i class="fa-regular fa-arrow-left icon-boton-primary"></i> Listado de Productos</a>
					</div>
				</div>
    		</div>
		</div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" placeholder="Escriba el nombre del producto" class="form-control" id="name" aria-describedby="name" required>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="code" placeholder="Genere un codigo para el producto" class="form-control" id="code" aria-describedby="code" required>
                                ...
                                <div id="combo" class="col-md-9 mb-1">
                                    ...
                                    <div class="search-box input-group mb-3">
                                        ...
                                        <input type="text" name="product_code_name" id="lims_productcodeSearch" placeholder="Escriba el nombre o codigo del producto..." class="form-control" />
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group pos">
                                          <select name="brand_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Seleccione una marca...">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group pos">
                                          <select name="category_id" required class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Seleccione una categoria...">
                                        ...
                                        <div class="col-md-4 form-group">
                                                ...
                                                <div class="input-group">
                                                  <select required class="form-control selectpicker" name="unit_id">
                                                    <option value="" disabled selected>Seleccione la unidad del producto...</option>
                                ...
                                <div id="cost" class="col-md-4">
                                     <div class="form-group">
                                        ...
                                        <div class="input-moneda"><input type="number" name="cost" required class="form-control" step="any"><i>Q. </i></div>
                                        <span class="validation-msg"></span>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-moneda"><input type="number" name="price" required class="form-control" step="any"><i>Q. </i></div>
                                        <span class="validation-msg"></span>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-moneda"><input type="number" name="wholesale_price" class="form-control" step="any"><i>Q. </i></div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>{{trans('file.Daily Sale Objective')}}</label> <i class="dripicons-question" data-toggle="tooltip" title="{{trans('file.Minimum qty which must be sold in a day. If not, you will be notified on dashboard. But you have to set up the cron job properly for that. Follow the documentation in that regard.')}}"></i>
...
<script type="text/javascript">
    ...
    tinymce.init({
	  ...
	  language_url: 'https://tienda.distribuidoratorrefuerte.com/vendor/tinymce/js/tinymce/langs/es.js', // path from the root of your web application — / — to the language pack(s)
