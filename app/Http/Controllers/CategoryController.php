...
class CategoryController extends Controller
{
            ...
            foreach ($categories as $key=>$category)
            {
                ...
                $nestedData['options'] = '<div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                <li>
                                    <button type="button" data-id="'.$category->id.'" class="open-EditCategoryDialog btn btn-link" data-toggle="modal" data-target="#editModal" ><i class="fa-regular fa-pen-to-square"></i> '.trans("file.edit").'</button>
                                </li>
                                <li class="divider"></li>'.
    ...
    public function destroy($id)
    {
        ...
        $lims_category_data->save();
        $this->cacheForget('category_list');
        return redirect('category')->with('not_permitted', 'Categoría eliminada exitosamente');
    }
}
